...
- F: Wie werden die Seminarplätze zugeteilt?
  ...
  - A: Die Seminarplätze werden gemäß des studentenoptimalen <a href="https://en.wikipedia.org/wiki/Stable_marriage_problem" target="_blank">Gale-Shapley Algorithmus</a> zugeteilt. Es ist hierbei eine dominante Strategie Ihre wahren Präferenzen über die Seminare anzugeben. Ihre Prioritäten über Seminarplätze werden zufällig bestimmt, Dozenten können aber höhere Prioritäten z. B. für Studierender gewisser Schwerpunktfächer vergeben.

- F: Ich brauche unbedingt noch ein Seminar. Wie kann ich garantiert einen Seminarplatz erhalten?

  - A: Sie müssen alle Seminare in Ihre Präferenzliste aufnehmen. Es gab bislang immer noch Seminare mit freien Plätzen. Sollten tatsächlich doch mal alle Seminarplätze ausgebucht sein, werden wir versuchen, die Gesamtzahl der Seminarplätze aufzustocken. Wenn Sie nicht alle Seminare in ihre Präferenzliste aufnehmen, kann es jedoch sein, dass sie keinen Seminarplatz erhalten. Je weniger Seminare Sie bereit sind zu besuchen, desto höher ist die Gefahr keinen Seminarplatz zu erhalten. 
...
- F: Sollten nicht z. B. Studierende eines Schwerpunktfaches höhere Chancen haben einen Seminarplatz in Ihren Schwerpunkt zu erhalten?

  - A: Dozenten können, soweit inhaltlich gerechtfertigt, solche Prioritäten vergeben. Dies hat aber keinen Einfluss auf die Gestaltung Ihrer Präferenzliste. Hier ist es stets optimal Ihre wahren Präferenzen über die Seminare anzugeben, unabhängig davon ob sie ggf. bei einem Seminar höhere Priorität haben.
  
- F: Sieht der Dozent auf welchen Platz ich sein Seminar gerankt habe?

  - A: Ein Dozent erfährt nicht, wie sie persönlich sein Seminar gerankt haben. 
