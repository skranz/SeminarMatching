...
The seminar selection for {{semester}} starts on **{{stud_start_date}}**. From then **until  {{round1_date-1}}** you must enter your seminar preferences in the tab "Seminars". The automated matching then takes place on {{round1_date}} at 3:00 in the night.
