...
cat(html.table(select(stud_sems, name, teacher, weblink),header = c("Seminar","Dozent","Link")))
```
...
Sie hier noch bis zum {{round2_date-1}} Präferenzen für die zweite Vergaberunde angeben. Die zentrale zweite Runde der Seminarplatzverteilung findet dann am {{round2_date}} statt.
#>
