...
- {{round1_date}}: 1st round of seminar matching. The matching algorithm is scheduled to run automatically at 3:00 in the morning.
...
- {{round2_date}}: 2nd round of seminar matching. The matching algorithm is scheduled to run automatically at 3:00 in the morning.
...
#>
- From {{round1_date}} onwards: Students may be able to submit preferences over seminar topics for their assigned seminars. Seminar instructors can set individual deadlines. 
