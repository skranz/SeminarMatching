...
- {{round1_date}}: 1st round of seminar matching. The matching algorithm runs during that day.
...
- {{round2_date}}: 2nd round of seminar matching. The matching algorithm runs during that day.
